...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'pinc' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'pinc' ),
		'repeat-y'  => __( 'Repeat Vertically', 'pinc' ),
		'repeat'    => __( 'Repeat All', 'pinc' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'pinc' ),
		'top center'    => __( 'Top Center', 'pinc' ),
		'top right'     => __( 'Top Right', 'pinc' ),
		'center left'   => __( 'Middle Left', 'pinc' ),
		'center center' => __( 'Middle Center', 'pinc' ),
		'center right'  => __( 'Middle Right', 'pinc' ),
		'bottom left'   => __( 'Bottom Left', 'pinc' ),
		'bottom center' => __( 'Bottom Center', 'pinc' ),
		'bottom right'  => __( 'Bottom Right', 'pinc')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'pinc' ),
		'fixed'  => __( 'Fixed in Place', 'pinc')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'pinc' ),
		'italic'      => __( 'Italic', 'pinc' ),
		'bold'        => __( 'Bold', 'pinc' ),
		'bold italic' => __( 'Bold Italic', 'pinc' )
		);
